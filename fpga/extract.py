...
* the Ultra96-V2 the way Avnet plot it, its USB ports along the bottom and
  its low-speed expansion header along the top
"""
...
def main() -> None:
    records = [extract_arty(), extract_ulx3s(), extract_pynq_z2(),
               ...
               extract_cynthion(), extract_ultra96_v2()]
    numbers = "{\n" + "".join(
